...
def paginate_query(
    ...
    if total == 0:
        return {
            "total": 0, "pages": 0, "page": page, "per_page": per_page, "items": []
        }

    if allowed_order and orde_by:
        col = allowed_order.get(orde_by, allowed_order.get('id'))
